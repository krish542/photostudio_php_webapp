...
if (isset($_POST['upload_model'])) {
    ...
    foreach ($_FILES['model_gallery']['name'] as $key => $val) {
        $upload_dir = "modeling_gallery/img/";
        $upload_file = $upload_dir . $_FILES['model_gallery']['name'][$key];
        $filename = $_FILES['model_gallery']['name'][$key];
        if (move_uploaded_file($_FILES['model_gallery']['tmp_name'][$key], $upload_file)) {
            $uploaded_images[] = $upload_file;
            $insert_sql = "INSERT INTO `tbl_model_gallery` (`model_imgpath`, `model_imgalt`) VALUES('modeling_gallery/img/" . $filename . "', '" . $altertxt . "')";
...
<head>
    ...
    <title>Admin - Model Editing</title>
...
<body style="overflow-x: hidden;">
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <!-- Main Content -->
            <h2>Modelling Portfolio Edting</h2>
                ...
                <div class="col-lg-4 bg-light rounded px-4">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="file" name="model_gallery[]" class="form-control p-1" required multiple>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type="submit" name="upload_model" class="btn btn-warning btn-block" value="upload image">
            ...
            <div style="width: 80vw;overflow-x:auto; word-wrap: break-word;">
                ...
                <tr>
                    ...
                    $query = "SELECT * FROM `tbl_model_gallery`";
                ...
                <tr>
                    <td>' . $srno . '</td>
                    <td>' . $row['model_imgpath'] . '</td>
                    <td>' . $row['model_imgalt'] . '</td>
                    <td><img src="' . $row['model_imgpath'] . '" width="400px" height = "150px"></td>
                    <td>
                        <a href="modeling_gallery/upd_model.php?upd_id=' . $img_id . '" class="edit btn btn-sm btn-primary" id="' . $row['model_id'] . '">Edit</a>
                        <a href="modeling_gallery/del_model.php?del_id=' . $row['model_id'] . '" class="delete btn btn-sm btn-primary" id="' . $row['model_id'] . '">Delete</a>
                    </td>
                </tr>
                </tbody>
                ';
            ...
            <div class="">
                <div class="resizable">
                    <iframe src="../modeling.php" height="200" width="300" title="Iframe_model"></iframe>
                </div>
                <div>
