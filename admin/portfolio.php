...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <!-- Wedding Portfolio -->
            <a class="nav-link" href = "wedding_editing.php"><h4>Wedding Portfolio Page</h4></a>            
            <a class="nav-link" href = "prewedding_editing.php"><h4>Pre-Wedding Portfolio Page</h4></a>
            <a class="nav-link" href = "baby_editing.php"><h4>Baby Portfolio Page</h4></a>
            <a class="nav-link" href = "modeling_editing.php"><h4>Modeling Portfolio Page</h4></a>
        </div>
    </div>
