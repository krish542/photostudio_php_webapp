...
<head>
    ...
    <link rel="stylesheet" href="admin/css/faq_style.css">
    <!-- Bootstrap -->
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: black;">
    ...
    <!-- End of Navbar -->
    <?php
    $query = "SELECT * FROM `tbl_faq` WHERE 1";
    ...
    ?>
        <div style="width:70%; margin-left:15%; margin-right: 15%">
            ...
            <div class="card">
                <div class="card-body">
                    <h6 class="card-subtitle mb-2 text-muted"><?php echo $row['ques']; ?></h6>
                    <p class="card-text"><?php echo $row['ans'] ?></p>
                </div>
            </div>
        </div>
    <?php
